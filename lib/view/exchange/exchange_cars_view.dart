...
class ExchangeCarsView extends StatefulWidget {
  const ExchangeCarsView({Key? key}) : super(key: key);

  @override
  State<ExchangeCarsView> createState() => _ExchangeCarsViewState();
}
...
class _ExchangeCarsViewState extends State<ExchangeCarsView> {
  ...
  void initState() {
    ...
    scrollControllerBuyCar.addListener(() {
      if (scrollControllerBuyCar.position.maxScrollExtent ==
        ...
        print('hello');
        exchangeController.apiGetExchangeCarsList();
      }
    });
  }
    ...
    return Scaffold(
        ...
        body: Column(
          children: [
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: TextField(
                        ...
                        // onChanged: (v) {
                        //   _debouncer.run(() {
                        //     exchangeController.onItemChanged(v);
                        //   });
                        // }
                        onTap: () {
                          Get.toNamed('exchangeSearchView', arguments: [
                            conditionId,
                            brandId,
                            modelId,
                            manufacturingYear,
            ...
            Expanded(
              child: Obx(
                () => (exchangeController.exchangeCarsLoader.value == true)
                    ? Center(
                    ...
                    : ListView.builder(
                        ...
                        // primary: true,
                        itemCount:
                            exchangeController.filterCarsListData.length + 1,
                        itemBuilder: (BuildContext context, int index) {
                          if (index <
                              exchangeController.filterCarsListData.length) {
                            return Padding(
                              padding:
                            ...
                            return Padding(
                              ...
                              child: Center(
                                  child: (exchangeController.hasMore.value)
