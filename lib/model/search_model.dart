class CarSearchData {
  ...
  late final List<SearchData> dashboardCars;

  CarSearchData.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    dashboardCars = List.from(json['dashboard_cars'])
...
class SearchData {
  ...
  late final CarDriveType? carDriveType;
  ...
  SearchData.fromJson(Map<String, dynamic> json) {
    ...
    menufacturingYear =
        (json['menufacturing_year'] == null) ? 0 : json['menufacturing_year'];
    milage = (json['milage'] == null) ? '' : json['milage'];
    engineCapacity = json['engine_capacity'];
    bodyType = (json['body_type'] == null) ? 0 : json['body_type'];
    fuelType = (json['fuel_type'] == null) ? '' : json['fuel_type'];
    transmission = json['transmission'];
    registrationYear = json['registration_year'];
    registrationSerial =
        (json['registration_serial'] == null) ? 0 : json['registration_serial'];
    registrationCity =
        (json['registration_city'] == null) ? 0 : json['registration_city'];
    registrationNumber = (json['registration_number'] == null)
        ? ""
        : json['registration_number'];
    driveType = (json['drive_type'] == null) ? 0 : json['drive_type'];
    exteriorColor = json['exterior_color'];
    interiorColor = json['interior_color'];
    comfort = (json['comfort'] == null) ? '' : json['comfort'];
    enterteinment =
        (json['enterteinment'] == null) ? '' : json['enterteinment'];
    safty = (json['safty'] == null) ? '' : json['safty'];
    seats = (json['seats'] == null) ? '' : json['seats'];
    wwindow = (json['wwindow'] == null) ? '' : json['wwindow'];
    others = (json['others'] == null) ? '' : json['others'];
    taxTokenExpaire =
        (json['tax_token_expaire'] == null) ? '' : json['tax_token_expaire'];
    fitnesExspaire =
        (json['fitnes_exspaire'] == null) ? '' : json['fitnes_exspaire'];
    ...
    carImages = List.from(json['car_images'])
        .map((e) => CarImages.fromJson(e))
        .toList();
    sellerFuelTypes = List.from(json['seller_fuel_types'])
        .map((e) => SellerFuelTypes.fromJson(e))
        .toList();
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['seller_fuel_types'] =
        sellerFuelTypes.map((e) => e.toJson()).toList();
    ...
    _data['car_drive_type'] = carDriveType;
...
class Images {
  Images({
    ...
    this.taxTokenPhoto,
    this.fitnessPhoto,
    this.bankClearancePhoto,
  });
  late final int sellerId;
  late final Null smartCardPhoto;
  late final String? taxTokenPhoto;
  late final Null fitnessPhoto;
  late final Null bankClearancePhoto;
...
class CarDriveType {
  ...
  CarDriveType.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    status = json['status'];
  }
