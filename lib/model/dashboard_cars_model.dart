class DashboardCarsData {
  ...
  late final List<DashboardCars> dashboardCars;

  DashboardCarsData.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    dashboardCars = List.from(json['dashboard_cars'])
        .map((e) => DashboardCars.fromJson(e))
        .toList();
  }
...
class DashboardCars {
  ...
  DashboardCars.fromJson(Map<String, dynamic> json) {
    id = json['id'];
