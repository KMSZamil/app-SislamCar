class CarDetailsData {
  ...
  late final List<CarDetails> carDetails;
  late final String videoId;

  CarDetailsData.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    carDetails = List.from(json['dashboard_car_selected'])
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['dashboard_car_selected'] =
        carDetails.map((e) => e.toJson()).toList();
...
class CarDetails {
  ...
  CarDetails.fromJson(Map<String, dynamic> json) {
    ...
    bankLoan = (json['bankLoan'] == null) ? '' : json['bankLoan'];
    ...
    carDriveType = CarDriveType.fromJson(json['car_drive_type']);
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['car_drive_type'] = carDriveType.toJson();
...
class Images {
  ...
  Images.fromJson(Map<String, dynamic> json) {
    ...
    smartCardPhoto =
        (json['smart_card_photo'] == null) ? '' : json['smart_card_photo'];
    taxTokenPhoto =
        (json['tax_token_photo'] == null) ? '' : json['tax_token_photo'];
    ;
    fitnessPhoto = (json['fitness_photo'] == null) ? '' : json['fitness_photo'];
    ;
    bankClearancePhoto = (json['bank_clearance_photo'] == null)
        ? ''
        : json['bank_clearance_photo'];
    ;
  }
